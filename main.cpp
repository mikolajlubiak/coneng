...
class ConEng : public olc::PixelGameEngine {
public:
	ConEng() { sAppName = "3D demo"; }
...
private:
	...
	void getTrianglesToRaster(const mesh& m, std::vector<triangle>& v, const mat4& matWorld, const mat4& matCamera) const {
...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override {
		...
		*/
		...
		for (const triangle& triToRaster : vecTriangleToRaster) {
